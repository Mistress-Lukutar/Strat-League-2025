...
class TelemetryPacket:
    ...
    def to_log_format(self, rssi: Optional[float] = None, snr: Optional[float] = None) -> str:
        ...
        lines.append(f"Temp: {temp_c:.2f} C\t Bat: {self.temp_bt:.2f} C")
        ...
        lines.append(f"alt: {self.gps_alt} m")
...
class TelemetryDecoder:
    ...
    def _decode_packet(self, data: bytes) -> TelemetryPacket:
        ...
        rad2 = r.read_bits(16)
        rad3 = r.read_bits(16)
        gps_alt = r.read_bits(16)
        bat_temp = r.read_bits(14)
        ...
        return TelemetryPacket(
            ...
            gps_alt=gps_alt, temp_bt=bat_temp
        )
